...
function Header(){
    ...
    return <nav className="header">
        ...
        <div className="header__links">
            <NavLink to={'/Accueil'} id="header__links--accueil" className={({ isActive}) => isActive ? "active" : ""} style={({isActive}) =>{return {textDecoration: isActive ? "underline" : ""}}}>ACCUEIL</NavLink>
