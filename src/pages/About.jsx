...
import {fiabilité_content,respect_content,service_content,securite_content} from '../../public/data/about.js'
import Banner from '../components/Banner'

function About() {
return (
    <div id="main">
      <Banner page="about" /><div className="collapses__section" id='collapses_about_page'>
